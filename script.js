...
function startDownload() {
    ...
    if (platform === 'windows') {
        ...
        // Try deep link first (opens Store app on Windows), fallback to web URL
        ...
        // Try deep link, fallback to web URL if it fails
        window.location.href = storeDeepLink;
        
        // Fallback to web URL after a short delay (in case deep link doesn't work)
        setTimeout(() => {
