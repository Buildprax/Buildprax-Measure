...
function startDownload() {
    ...
    if (platform === 'mac') {
        ...
        downloadLink = 'https://buildprax-downloads.sfo3.digitaloceanspaces.com/Buildprax%20Measure%20Pro-0.1.0-arm64.dmg';
        filename = 'Buildprax Measure Pro-0.1.0-arm64.dmg';
    } else {
        // Default to Mac
        downloadLink = 'https://buildprax-downloads.sfo3.digitaloceanspaces.com/Buildprax%20Measure%20Pro-0.1.0-arm64.dmg';
        filename = 'Buildprax Measure Pro-0.1.0-arm64.dmg';
